...
const Contect = () => {
    return (
        <>
            <div style={{ backgroundImage: "url('./m11.jpg')", }} className='lg:h-[500px]  bg-cover max-lg:h-[300px] '>
                <p className='text-5xl max-lg:text-3xl  pt-10 font-extrabold text-white text-center'>Contect Us</p>
