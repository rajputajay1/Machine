...
const Form = () => {
  return (
      <>
            <div style={{ backgroundImage: "url('./m5.jpg')", }} classNameName='py-20 bg-cover mt-10'>
              
            <div className="bg-white border-4 rounded-lg shadow relative m-10">

<div className="flex items-center justify-center py-2 border-b rounded text-center bg-yellow-400 ">
